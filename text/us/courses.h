COURSE_ACTS(COURSE_BOB, _(" 1 BATALLA BOB-OMB"),
       _("BOB-OMB EN LA CIMA")     , _("CARRERA CON KOPA EL VELOZ") , _("DISPARADO A LA ISLA FLOTANTE"),
       _("BUSCA LAS MONEDAS ROJAS")          , _("MARIO VUELA EN EL CIELO")        , _("LIBERA A FIRULAIS"))

COURSE_ACTS(COURSE_WF, _(" 2 FORTALEZA WHOMP'S"),
       _("ACABA CON EL REY PIEDRA")        , _("EN LA CIMA DE LA FORTALEZA")    , _("DISPARATE A LA PLATAFORMA"),
       _("BUSCA LAS MONEDAS ROJAS"), _("CAE EN LA JAULA")    , _("ROMPE LA PARED"))

COURSE_ACTS(COURSE_JRB, _(" 3 JOLLY ROGER BAY"),
       _("TESORO DEL BARCO")    , _("PUEDE JUGAR LA ANGUILA?") , _("TESORO EN LA CUEVA"),
       _("BUSCA LAS MONEDAS ROJAS")  , _("LANZATE AL PILAR")     , _("EN MEDIO DEL TORNADO"))

COURSE_ACTS(COURSE_CCM, _(" 4 COOL, COOL MOUNTAIN"),
       _("DESLIZA POR DENTRO")             , _("PINGUINO PERDIDO")             , _("CARRERA PINGUINEZCA"),
       _("BUSCA LAS MONEDAS ROJAS")  , _("CABEZA DEL HOMBRE NEVADO")       , _("SALTO EN LAS ALTURAS"))

COURSE_ACTS(COURSE_BBH, _(" 5 BIG BOO'S HAUNT"),
       _("ACABA CON LOS FANTASMAS")            , _("FIESTA DE FANTASMAS OCULTA") , _("SECRETO DE LOS LIBROS"),
       _("BUSCA LAS MONEDAS ROJAS")          , _("REY FANTASMA EN BALCON")             , _("EL SECRETO DEL GRAN OJO"))
